...
const faqs = [
  ...
  {
    q: '諮詢以甚麼方式進行？',
    a: '所有諮詢均以 WhatsApp 視像通話或語音通話形式進行，方便全球客戶。諮詢後會提供錄音及 PDF 報告供您留存。',
  },
  {
    q: '八字命理是迷信嗎？',
  ...
  {
    q: '諮詢結果準確嗎？',
    a: '八字分析的準確性取決於命盤資訊的精確度及師傅的經驗。師傅擁有多年研究及實際諮詢經驗，會以客觀、務實的態度為您分析，並提供具體可行的建議。',
  },
  {
    q: '合婚分析需要兩人同時在場嗎？',
  ...
  {
    q: '如果對分析結果有疑問，可以再提問嗎？',
    a: '可以。諮詢後如有任何疑問，可於 7 天內透過 WhatsApp 提問，師傅會為您解答。',
  },
]
